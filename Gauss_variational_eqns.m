function Gauss_variational_eqns
...
i0 = 1.10654; % degrees, initial inclination angle 
e0 = 0.74; % initial eccentricity 
w0 = 5.*(pi./180); % radians, initial argument of perigee angle
omega0 = 90.*(pi./180); % radians, initial right ascension of the node
M0 = 10.*(pi./180); % radians, initial man anomaly 
